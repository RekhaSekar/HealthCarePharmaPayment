...
<body>
	...
	<div>
		<form:form class="Container" modelAttribute="admin" name="form1"
			action="/adminRegistration" method="GET">
			...
			<div class="form-group">
				...
				<form:input class="form-control" type="text" path="adminId"
			...
			<br>
			<p id="validation">
				Already registered?<a id=a2 href="/adminLoginPage" title="login">
					Login here.</a>
			</p>
		</form:form>
	</div>
